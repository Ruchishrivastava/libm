class Admin::BooksController < ApplicationController
  ...
  def create
    ...
    @admin_subject= Admin::Subject.find(params[:admin_book][:subject_id])
    @admin_book = @admin_subject.books.build(admin_book_params)
  ...
  private
    ...
    def admin_book_params
      params.require(:admin_book).permit(:book_name, :author_name, :picture)
    end
end
